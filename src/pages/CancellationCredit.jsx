...
const CancellationCredit = () => {
  ...
  const handleConfirmCancellation = () => {
    ...
    setConfirmAction({
      message: "Are you sure you want to cancel this booking and process the credit?",
      onConfirm: () => {
        setCancelled(true);
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div className="page-container">
        <div style={{ marginBottom: '2.5rem' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text-primary)' }}>Cancellation for Credit</h1>
          <p style={{ fontSize: '1rem', color: 'var(--text-secondary)' }}>Search and manage credit requests.</p>
        </div>
            ...
            {!cancelled ? (
              ...
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                ...
                <p style={{ color: '#4b5563', marginBottom: '1.5rem' }}>
                  Booking {selectedReservation.id} has been cancelled and credit initiated.
                </p>
...
export default CancellationCredit;
